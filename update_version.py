...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright Andrew, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/LCRChorus-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/LCRChorus-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/LCRChorus-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/LCRChorus-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/LCRChorus-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/LCRChorus-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/LCRChorus-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/LCRChorus.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/LCRChorus.iss",inplace=1):
