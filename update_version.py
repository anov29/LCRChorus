...
def main():
  ...
  plistpath = scriptpath + "/resources/DFlanger-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DFlanger-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DFlanger-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DFlanger-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DFlanger-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DFlanger-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/DFlanger-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/DFlanger.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/DFlanger.iss",inplace=1):
